              ...
              <form onSubmit={handleAddRoutine} className="p-5 rounded-2xl border border-slate-800 bg-slate-950/30 flex flex-col lg:flex-row items-center gap-4 relative z-10">
                ...
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-3.5 flex-1">
                  <input
                    ...
                    className="bg-slate-950 border border-slate-800 text-slate-200 rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-indigo-500 placeholder:text-slate-600 transition-all"
                    required
                  />
                ...
                <button
                  type="submit"
                  className="w-full lg:w-auto bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs px-6 py-3 rounded-xl transition-all shadow-lg hover:shadow-indigo-600/10 active:scale-95 shrink-0 flex items-center justify-center space-x-1.5 cursor-pointer"
                >
                  ...
                  {DAYS_OF_WEEK.map(day => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => handleToggleRoutineDay(r.id, day)}
                        disabled={isEditing}
                        className={`py-2 rounded-xl border flex flex-col items-center justify-center space-y-1 transition-all disabled:opacity-50 ${
                          isCompleted 
                      ...
                      >
                        <span className="text-[8px] font-bold uppercase">{day.substring(0, 3)}</span>
