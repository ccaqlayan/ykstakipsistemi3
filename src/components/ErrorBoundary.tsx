        ...
        <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 text-center">
          <div className="bg-slate-900/80 backdrop-blur-md p-8 rounded-3xl border border-rose-500/30 max-w-lg shadow-2xl">
            ...
            <p className="text-slate-400 text-sm mb-3">
              Bu sayfa yüklenirken kritik bir hata meydana geldi.
              {this.state.error && (
            ...
            <p className="text-amber-400/90 text-xs mb-6 bg-amber-500/10 border border-amber-500/20 rounded-xl px-4 py-2.5">
              ⚠️ Hata devam ederse lütfen sistem yöneticinize (okul danışmanı veya müdür) bilgi verin.
            </p>
            <button
