...
export const INITIAL_STATE: YKSDataState = {
  ...
  questionLogs: [
    ...
    },
    {
      ...
      date: '2026-08-14',
      subject: 'AYT Biyoloji',
      topic: 'Genden Proteine (Protein Sentezi)',
      examType: 'AYT',
      targetCount: 45,
      solvedCount: 45,
      correctCount: 41,
    ...
    },
    {
      ...
      date: '2026-08-13',
      subject: 'Paragraf',
      topic: 'Paragrafta Anlam & Hızlı Okuma',
      examType: 'TYT',
      targetCount: 40,
      solvedCount: 40,
      correctCount: 37,
    ...
    },
    {
      ...
      date: '2026-08-13',
      subject: 'AYT Matematik',
      topic: 'Türev (Teğet ve Normal Denklemleri)',
      examType: 'AYT',
      targetCount: 50,
      solvedCount: 50,
      correctCount: 45,
    ...
    },
    {
      ...
      date: '2026-08-12',
      subject: 'AYT Fizik',
      topic: 'Elektriksel Kuvvet, Alan ve Potansiyel',
      examType: 'AYT',
      targetCount: 35,
      solvedCount: 35,
      correctCount: 30,
    ...
    },
    {
      ...
      date: '2026-08-12',
      subject: 'TYT Geometri',
      topic: 'Üçgenlerde Açılar & Özel Üçgenler',
      examType: 'TYT',
      targetCount: 30,
      solvedCount: 30,
      correctCount: 27,
    ...
    },
    {
      ...
      date: '2026-08-11',
      subject: 'AYT Kimya',
      topic: 'Organik Kimya (Alkanlar ve Alkenler)',
      examType: 'AYT',
      targetCount: 40,
      solvedCount: 40,
      correctCount: 38,
    ...
    },
    {
      ...
      date: '2026-08-11',
      subject: 'AYT Matematik',
      topic: 'İntegral (Değişken Değiştirme ve Alan)',
      examType: 'AYT',
      targetCount: 55,
      solvedCount: 55,
      correctCount: 50,
    ...
    },
    {
      ...
      date: '2026-08-10',
      subject: 'TYT Türkçe',
      topic: 'Yazım Kuralları & Ses Bilgisi',
      examType: 'TYT',
      targetCount: 50,
      solvedCount: 50,
      correctCount: 44,
    ...
    },
    {
      ...
      date: '2026-08-08',
      subject: 'Paragraf',
      topic: 'Paragraf Çözüm Teknikleri',
      examType: 'TYT',
      targetCount: 30,
      solvedCount: 30,
      correctCount: 28,
    ...
    },
    {
      ...
      date: '2026-08-07',
      subject: 'AYT Biyoloji',
      topic: 'Sinir Sistemi & İmpuls İletimi',
      examType: 'AYT',
      targetCount: 45,
      solvedCount: 45,
      correctCount: 40,
    ...
    },
    {
      ...
      date: '2026-08-06',
      subject: 'TYT Matematik',
      topic: 'Sayılar & Yeni Nesil Problemler',
      examType: 'TYT',
      targetCount: 70,
      solvedCount: 70,
      correctCount: 63,
    ...
    },
    {
      ...
      date: '2026-08-06',
      subject: 'AYT Fizik',
      topic: 'Kuvvet ve Hareket (Newton Yasaları)',
      examType: 'AYT',
      targetCount: 40,
      solvedCount: 38,
      correctCount: 33,
    ...
    },
    {
      ...
      date: '2026-08-05',
      subject: 'TYT Geometri',
      topic: 'Dik Üçgen ve Trigonometrik Oranlar',
      examType: 'TYT',
      targetCount: 35,
      solvedCount: 35,
      correctCount: 32,
    ...
    },
    {
      ...
      date: '2026-08-04',
      subject: 'AYT Matematik',
      topic: 'Trigonometri (Yarım Açı & Denklemler)',
      examType: 'AYT',
      targetCount: 50,
      solvedCount: 50,
      correctCount: 44,
    ...
    },
    {
      ...
      date: '2026-08-03',
      subject: 'Paragraf',
      topic: 'Paragrafta Ana Düşünce ve Yardımcı Düşünceler',
      examType: 'TYT',
      targetCount: 40,
      solvedCount: 40,
      correctCount: 36,
    ...
    },
    {
      ...
      date: '2026-08-02',
      subject: 'AYT Biyoloji',
      topic: 'Dolaşım Sistemi & Bağışıklık',
      examType: 'AYT',
      targetCount: 40,
      solvedCount: 40,
      correctCount: 36,
    ...
    },
    {
      ...
      date: '2026-07-30',
      subject: 'AYT Fizik',
      topic: 'Çembersel Hareket & Virajlar',
      examType: 'AYT',
      targetCount: 35,
      solvedCount: 35,
      correctCount: 30,
    ...
    },
    {
      ...
      date: '2026-07-29',
      subject: 'TYT Matematik',
      topic: 'Yüzde, Kâr-Zarar & Karışım Problemleri',
      examType: 'TYT',
      targetCount: 50,
      solvedCount: 50,
      correctCount: 45,
    ...
    },
    {
      ...
      date: '2026-07-27',
      subject: 'Paragraf',
      topic: 'Paragrafta Yapı & Anlatım Teknikleri',
      examType: 'TYT',
      targetCount: 30,
      solvedCount: 30,
      correctCount: 28,
    ...
    },
    {
      ...
      date: '2026-07-25',
      subject: 'AYT Matematik',
      topic: 'Limit ve Süreklilik (Belirsizlikler)',
      examType: 'AYT',
      targetCount: 55,
      solvedCount: 55,
      correctCount: 49,
    ...
    },
    {
      ...
      date: '2026-07-22',
      subject: 'AYT Fizik',
      topic: 'Manyetizma ve Elektromanyetik İndüksiyon',
      examType: 'AYT',
      targetCount: 35,
      solvedCount: 35,
      correctCount: 31,
    ...
    },
    {
      ...
      date: '2026-07-21',
      subject: 'TYT Türkçe',
      topic: 'Cümlede Anlam & Cümlenin Ögeleri',
      examType: 'TYT',
      targetCount: 40,
      solvedCount: 40,
      correctCount: 37,
    ...
    },
    {
      ...
      date: '2026-07-20',
      subject: 'AYT Kimya',
      topic: 'Kimya ve Elektrik (Elektrotlar & Piller)',
      examType: 'AYT',
      targetCount: 45,
      solvedCount: 45,
      correctCount: 41,
    ...
    },
    {
      ...
      date: '2026-07-19',
      subject: 'AYT Matematik',
      topic: 'Türevin Geometrik Yorumu & Ekstremum',
      examType: 'AYT',
      targetCount: 60,
      solvedCount: 60,
      correctCount: 54,
    ...
    },
    {
      ...
      date: '2026-07-18',
      subject: 'Paragraf',
      topic: 'Paragraf Akışını Bozan Cümleler',
      examType: 'TYT',
      targetCount: 35,
      solvedCount: 35,
      correctCount: 33,
    ...
    },
    {
      ...
      date: '2026-07-17',
      subject: 'TYT Matematik',
      topic: 'Kümeler, Mantık ve Fonksiyonlar',
      examType: 'TYT',
      targetCount: 50,
      solvedCount: 50,
      correctCount: 46,
    ...
    },
    {
      ...
      date: '2026-07-16',
      subject: 'AYT Biyoloji',
      topic: 'Solunum Sistemi & Gaz Taşınması',
      examType: 'AYT',
      targetCount: 30,
      solvedCount: 30,
      correctCount: 28,
